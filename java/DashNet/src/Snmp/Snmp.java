...
public class Snmp extends AbstractGet{
    ...
    public Snmp(){
        ...
        try{
            ...
            RequestBuilder builder = new RequestBuilder.Builder().address("127.0.0.1/161") //147.26.195.63/161")
                    .community("public")    //txssc")
                    .build();
...
*/
            System.out.println("\n\n ****** GET AS STRING ****** ");
            for(OID oid : oids){
                System.out.println(builder.getAsString(oid));
            }
